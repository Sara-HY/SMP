...
def build_data_cv(data_folder, cv=10):
    ...
    """
    revs = []
    femaleFile = data_folder[0]
    maleFile = data_folder[1]
    vocab = defaultdict(float)
    with open(femaleFile, "r") as f:
        for line in f:
            rev = []
...
if __name__ == "__main__":
    ...
    cPickle.dump([revs, W, word_idx_map, vocab], open('weiboGender.p', 'w'))
