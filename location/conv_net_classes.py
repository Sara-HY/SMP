...
class MLPDropout(object):
    ...
    def __init__(self,rng,input,layer_sizes,dropout_rates,activations,use_bias=True, logW=None, logb=None):
        ...
        layer_counter = 0
        for n_in, n_out in self.weight_matrix_sizes[:-1]:    # self.weight_matrix_sizes[:-1] is a empty list, no hidden layer
        ...
        dropout_output_layer = LogisticRegression(
                input=next_dropout_layer_input,
                n_in=n_in, n_out=n_out, W=logW, b=logb)
